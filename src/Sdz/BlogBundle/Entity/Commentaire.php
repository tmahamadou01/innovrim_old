...
class Commentaire
{
	...
	*/
	public function increase()
	{
		...
		$nbCommentaires = $this->getPublication()->getNbCommentaires();
		$this->getPublication()->setNbCommentaires($nbCommentaires+1);
	}
	...
	*/
	...
	/**
	 * @ORM\ManyToOne(targetEntity="Sdz\BlogBundle\Entity\Publication", inversedBy="commentaires"))
	 * @ORM\JoinColumn(nullable=false)
	 */
	private $publication;
     ...
     * Set publication
     *
     * @param \Sdz\BlogBundle\Entity\Publication $publication
     * @return Commentaire
     */
    public function setPublication(\Sdz\BlogBundle\Entity\Publication $publication)
    {
     ...
     * Get publication
     *
     * @return \Sdz\BlogBundle\Entity\Publication 
     */
